...
Ações: BRSR6, CBAV3, UGPA3, NEOE3, ALOS3, BRAP4, FIQE3
===============================================================
...
TICKERS = {
    ...
    "UGPA3": "Ultrapar (Combustíveis e Logística)",
    "NEOE3": "Neoenergia (Energia Elétrica)",
    "ALOS3": "Allos (Shopping Centers)",
    "BRAP4": "Bradespar (Holding com participação na Vale)",
